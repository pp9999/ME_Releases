...
LODESTONES.BANDIT_CAMP = buildLodestone(8, WPOINT.new(3214, 2955, 0))
LODESTONES.BURTHOPE = buildLodestone(12, WPOINT.new(2899, 3544, 0))
LODESTONES.CANIFIS = buildLodestone(28, WPOINT.new(3517, 3515, 0))
...
LODESTONES.LUNAR_ISLE = buildLodestone(11, WPOINT.new(2085, 3914, 0))
...
LODESTONES.OOGLOG = buildLodestone(32, WPOINT.new(2532, 2871, 0))
LODESTONES.PORT_SARIM = buildLodestone(20, WPOINT.new(3011, 3215, 0))
LODESTONES.PRIFDDINAS = buildLodestone(36, WPOINT.new(2208, 3360, 1))
LODESTONES.SEERS_VILLAGE = buildLodestone(21, WPOINT.new(2689, 3482, 0))
LODESTONES.TAVERLEY = buildLodestone(22, WPOINT.new(2878, 3442, 0))
LODESTONES.TIRANNWN = buildLodestone(33, WPOINT.new(2254, 3149, 0))
LODESTONES.UM = buildLodestone(37, WPOINT.new(1084, 1768, 1))
LODESTONES.VARROCK = buildLodestone(21, WPOINT.new(3214, 3376, 0))
LODESTONES.WILDERNESS = buildLodestone(32, WPOINT.new(3143, 3636, 0))
LODESTONES.YANILLE = buildLodestone(25, WPOINT.new(2529, 3095, 0))
